function varargout = mvadBooterAdv(varargin)
% MVADBOOTERADV MATLAB code for mvadBooterAdv.fig
%      MVADBOOTERADV, by itself, creates a new MVADBOOTERADV or raises the existing
%      singleton*.
%
%      H = MVADBOOTERADV returns the handle to a new MVADBOOTERADV or the handle to
%      the existing singleton*.
%
%      MVADBOOTERADV('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MVADBOOTERADV.M with the given input arguments.
%
%      MVADBOOTERADV('Property','Value',...) creates a new MVADBOOTERADV or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mvadBooterAdv_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mvadBooterAdv_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to pushbutton_help mvadBooterAdv

% Last Modified by GUIDE v2.5 05-Apr-2017 09:06:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mvadBooterAdv_OpeningFcn, ...
                   'gui_OutputFcn',  @mvadBooterAdv_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mvadBooterAdv is made visible.
function mvadBooterAdv_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mvadBooterAdv (see VARARGIN)

% Choose default command line output for mvadBooterAdv
...
handles.mainGUI = findobj('Tag','mvadBooter');
...
% UIWAIT makes mvadBooterAdv wait for user response (see UIRESUME)
% uiwait(handles.mvadBooterAdv);


% --- Outputs from this function are returned to the command line.
function varargout = mvadBooterAdv_OutputFcn(hObject, eventdata, handles) 
